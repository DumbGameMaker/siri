        ...
        fs.readFile("./sPay.json", (err, sPayUnparsedData) => {
          ...
          for (var sPayAcct of sPayData.accts) {
            ...
            if (sPayAcct.user == message.author.id) {
              ...
              if (Date.now() - Number(sPayAcct.lastReceived) > 600000) {
                ...
                fs.writeFile(
                  "./sPay.json",
                  JSON.stringify(sPayData, null, 2),
                  (err) => {
                    message.channel.send(
                      "Sure. I sent __**" +
                        newBal +
                        "**__ to your Samsung Pay account. The current balance of your Samsung Pay Account is __**" +
                        (Number(sPayAcct.balance) + Number(newBal)) +
                        "**__. Enjoy! :grin:"
                    );
                  }
                );
                ...
                message.channel.send(
                  "Sorry, but for security reasons, Samsung Pay won't let me send any more money to your account since I have sent money to your Samsung Pay account in the last 10 minutes. :pensive:"
                );
              }
            }
          }
          ...
          if (!sPayAcctExists) {
            ...
            fs.writeFile(
              ...
              (err) => {
                message.channel.send(
                  "Sure. I created a Samsung Pay Account for you and sent __**" +
                    newBal +
                    "**__ to your Samsung Pay account. The current balance of your Samsung Pay Account is __**" +
                    sPayAcct.balance +
                    "**__. Enjoy! :grin:"
      ...
      fs.readFile("./sPay.json", (err, sPayUnparsedData) => {
        ...
        for (var sPayAcct of sPayData.accts) {
          ...
          if (sPayAcct.user == message.author.id) {
            ...
            const sPayAcctEmbed = new Discord.MessageEmbed()
              ...
              .setColor("#0099ff")
              .setAuthor(
                message.author.username + "'s Samsung Pay Account:",
                message.author.avatarURL(),
                "https://discord.js.org"
              )
              .setThumbnail(
                "https://cdn.discordapp.com/attachments/821049608519417857/825214854481575946/16168169422016489940937664778163.png"
              )
              ...
              .addField(
                "Tip:",
                "Tell me `send me money` to create obtain a larger balance on your Samsung Pay account."
              )
              .setTimestamp()
        ...
        if (!sPayAcctExists) {
          const sPayNoAcctEmbed = new Discord.MessageEmbed()
            ...
            .addField(
              "Tip:",
              "Tell me `send me money` to create a Samsung Pay Account and obtain a balance."
            )
            .setTimestamp()
            .setFooter("Samsung Pay", message.author.avatarURL());
